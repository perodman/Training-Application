...
.then(json => {
    ...
    // Initiera timern korrekt vid start om det finns ett aktivt pass
...
function startWorkout(workout, data = null, date = null, isImmediateStart = false) {
    // Behåll tiden om den redan finns i draften, annars nollställ
    ...
    // Starta bara timern om passet faktiskt är startat och inte pausat
...
function renderActiveWorkout() {
    ...
    // "Kasta träningspass"-knapp
    const discardBtn = document.getElementById("pause-workout-btn");
    discardBtn.innerHTML = `Kasta pass 🗑️`; 
