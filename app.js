...
function openDayManager(dateStr, planned, completed, isOngoing) {
    ...
    let html = `
        <div style="text-align: center; margin: 0 !important; padding: 0 !important;">
            ...
            <h2 class="section-title modern-header" style="margin: 30px 0 0 0 !important; padding: 0 !important; display: inline-block; font-size: 26px; line-height: 1.1 !important;">
                ${dateStr}
            </h2>
        </div>
    `;
